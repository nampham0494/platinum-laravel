	...
	<div class="main">
		<div class="content-box">
			...
			<div class="row">
				...
				<div @keyup.enter="getUsers" class="col-md-6 sm-text-center form-inline justify-content-end">
					...
					<button class="btn btn-primary" @click="getUsers"><i class="pe-7s-search"></i> Search</button>
				</div>
			</div>
