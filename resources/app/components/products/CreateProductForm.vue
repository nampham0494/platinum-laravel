			...
			<div class="col-md-6">
				<div class="content-box">
					<div class="content-box-header">
						<div class="box-title">Create New Product</div>
						<div class="box-description">This is a form to create new product</a></div>
					</div>
					<form>
					...
					<div class="content-box-footer text-right">
						...
						<button type="button" class="btn btn-primary" @click="createProduct" :disabled="btnAction != 'Save' ? true : false">{{ btnAction }}</button>
					</div>
				</div>
			</div>
		</div>
	...
	export default {
		...
		methods: {
			...
			createProduct() {
				...
				product.createProduct(self.form, data => {
					this.$router.push({
						name: 'products'
					})
				}, err => {
