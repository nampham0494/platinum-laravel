<template>
	<div class="content-box-footer">
		<div class="row">
			...
			<div class="col-md-3 form-inline mt-2 sm-text-center">Showing {{ showing.first }} - {{ showing.last }} of {{ items.total }} items</div>
			<div class="col-md-6">
				<ul class="pagination pull-right mt-2">
					<li v-for="pagination in paginations" :class="{ 'active': pagination.active }" @click="changePage(pagination.value)">
						<a v-if="pagination.text == 'First'" href="javascript:;">First</a>
						<a v-else-if="pagination.text == 'Prev'" href="javascript:;">Previous</a>
						<a v-else-if="pagination.text == 'Next'" href="javascript:;">Next</a>
						<a v-else-if="pagination.text == 'Last'" href="javascript:;">Last</a>
